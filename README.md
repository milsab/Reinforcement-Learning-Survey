...
Like the first book, this book also includes discussion on both tabular RL and Deep RL. However, this book is very intuitional. The author has tried to explain concepts in a very intuitive way by avoiding going deep into maths. All the necessary maths has been discussed though. Also, it has explanations of many recent major deep RL algorithms. 
### Online Cources
...
It is another series of lectures that have been taught at the University of College London. The instructor is Hado Van Hasselt who also is a senior research scientist at Google DeepMind. He has had a major influence to introduce the DDQN algorithm in a [paper](https://dl.acm.org/doi/10.5555/3016100.3016191) called "Deep Reinforcement Learning with Double Q-learning".
